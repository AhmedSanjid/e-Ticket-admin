                                ...
                                <div class="x_content">
                                    <form class="" action="" method="post" novalidate>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" class='optional' name="district_name" id="district_name" data-validate-length-range="5,15" type="text" /></div>
                                        </div>
                                    ...
                                    <?php 
                                        if($_POST){
                                            ...
                                            $_POST['created_by']=1;
                                            $rs=$mysqli->common_create('district',$_POST);
                                            if($rs){
                                                if($rs['data']){
