                                ...
                                <div class="x_content">
                                    ...
                                    <div class="field item form-group">
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="Price" required="required" />
                                            </div>
                                        </div>
                                        <div class="ln_solid">
                                    ...
                                    <?php 
                                        if($_POST){
                                            ...
                                            $_POST['created_by']=1;
                                            $rs=$mysqli->common_create('vehicle_seat_type',$_POST);
                                            if($rs){
                                                if($rs['data']){
